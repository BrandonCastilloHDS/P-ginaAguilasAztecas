...
function Heraldica() {
  return (
    <section id="heraldica" className="bg-[#00519e] py-24 relative overflow-hidden">

      {/* Background accent */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-[#fdc400]/5 rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#00296b]/20 rounded-full translate-y-1/2 -translate-x-1/2 pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 relative z-10">

        {/* Header */}
        <div className="text-center mb-16">
          <p className="text-[#ffe84f] text-[10px] font-bold tracking-[0.5em] uppercase mb-3">
            Identidad Visual
          </p>
          <h2 className="text-5xl md:text-6xl font-black text-white mb-4 tracking-wide">
            HERÁLDICA
          </h2>
          <div className="w-20 h-1 bg-[#fdc400] mx-auto mb-6" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {elementos.map((el, i) => (
            <div
              key={i}
              className="bg-[#003f87]/50 border border-white/10 p-6 hover:border-[#fdc400]/40 hover:bg-[#003f87]/70 transition-all duration-300"
            >
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-8 h-8 bg-[#fdc400] flex items-center justify-center">
                  <span className="text-[#00296b] text-xs font-black">{String(i + 1).padStart(2, '0')}</span>
                </div>
                <div>
                  <h4 className="text-[#fdc400] text-sm font-black uppercase tracking-wider mb-2">
                    {el.titulo}
                  </h4>
        ...
        <div className="mt-10 bg-[#00296b]/60 border border-[#fdc400]/20 p-8">
          <p className="text-[#fdc400] text-[9px] font-black tracking-[0.4em] uppercase mb-2">
            Significado Conjunto
          </p>
          <p className="text-white/80 text-sm leading-relaxed max-w-4xl">
            ...
            vuelan juntos en cada actuación de las <span className="text-[#fdc400] font-bold">Águilas Aztecas</span>.
          </p>
        </div>
      </div>
    </section>
