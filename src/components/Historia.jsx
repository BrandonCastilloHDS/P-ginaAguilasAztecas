  ...
  return (
    <div className="pt-[52px]">
      ...
      {opcionActiva === 'historia' && (
        <section className="bg-[#132b49] py-20 flex flex-col xl:flex-row items-center justify-center">
          <div className="max-w-5xl mx-auto px-6 space-y-7 text-base shrink-0 ">
      ...
      {opcionActiva === 'historia' && (
        <section className="bg-[#132b49] text-white py-20 ">
    ...
    {opcionActiva === 'heraldica' && ( 
      ...
      <section className="bg-[#132b49] py-20 ">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start text-xl">

            {/* Elementos heráldicos */}
            <div className="space-y-5 text-base ">
              {heraldica.map((el, i) => (
                <div key={i} className="bg-[#0b1728] border   p-5 shadow-sm">
                  ...
                  {el.texto && (
                    <p className="text-white  leading-relaxed">{el.texto}</p>
                  )}
                  {el.lista && (
                    <ul className="space-y-1.5 mt-1">
                      {el.lista.map((item, j) => (
                        <li key={j} className="flex items-start gap-2 text-white">
                          <div className="mt-1.5 w-1.5 h-1.5 bg-[#006847] shrink-0" />
                          {item}
                        </li>
                      ))}
                    </ul>
              ...
              <div className="bg-[#0b1728] p-5">
                <h4 className="text-[#b88a2a] font-black uppercase tracking-wider mb-2 flex items-center gap-2">
                  <span className="w-4 h-0.5 bg-[#b88a2a]" />
                  Significado Conjunto
                </h4>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-gray-400 text-center uppercase tracking-widest">
